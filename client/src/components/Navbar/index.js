...
function Navbar() {
    ...
    const menuItems = [
    { route: "/dashboard", icon: "fa fa-dashboard", text: "Início", activeProp: "dashboard", allowedIds: ["jmichelotto","arodrigues","glopes", "wesleyf","ajunior", "wgoncalves", "gpsilva", "dcustodio","vhsilva","csilva","dbarbosa","apsilva","jvalter","wteixeira","wnascimento","grifo","enascimento","toliveira","mmsantos", "mssilva","tazevedo","nalves","rpsouza","gmsantos","amsouza","hollanda","dcruz","walmeida"] },
    { route: "/navios", icon: "fa fa-ship icon", text: "Navios", activeProp: "navios", allowedIds: ["jmichelotto","arodrigues","vhsilva","ajunior","glopes",  "wesleyf","dbarbosa", "wgoncalves",  "dcustodio", "csilva","apsilva","jvalter","wteixeira","wnascimento","grifo","enascimento","toliveira","mmsantos", "mssilva","tazevedo","nalves","rpsouza","gmsantos","amsouza","hollanda","dcruz","walmeida"] },
    { route: "/cargas", icon: "fa fa-area-chart icon", text: "Cargas", activeProp: "cargas", allowedIds: ["jmichelotto","arodrigues","vhsilva","ajunior", "csilva", "wesleyf","glopes","dbarbosa", "wgoncalves","dcustodio", "mssilva","apsilva","jvalter","wteixeira","wnascimento","grifo","enascimento","toliveira","mmsantos","tazevedo","nalves","rpsouza","gmsantos","amsouza","hollanda","dcruz","walmeida"] },
    { route: "/veiculos/BuscarMotorista", icon: "fa fa-truck icon", text: "Autos", activeProp: "veiculos", allowedIds: ["jmichelotto","csilva", "ajunior","vhsilva", "wesleyf","arodrigues", "glopes", "wgoncalves","dcustodio", "mssilva","dbarbosa","apsilva","jvalter","wteixeira","wnascimento","grifo","enascimento","toliveira","mmsantos","tazevedo","nalves","rpsouza","gmsantos","amsouza","hollanda","dcruz","walmeida"] },
    { route: "/operacoes",  icon: "fa fa-anchor", text: "Operação", activeProp: "operacao", allowedIds: ["jmichelotto","arodrigues","vhsilva","gpsilva", "csilva","ajunior", "wesleyf","dbarbosa","wgoncalves", "glopes", "dcustodio", "mssilva","apsilva","jvalter","wteixeira","wnascimento","grifo","enascimento","toliveira","mmsantos","tazevedo","nalves","rpsouza","gmsantos","amsouza","hollanda","dcruz","walmeida"] },
    ...
    { route: "/CadastroInfo", icon: " fas fa-plus-square", text: "Cadastrar", activeProp: "CadastroInfo", allowedIds: [ "grifo", "jmichelotto", "nalves", "glopes", "vhsilva"] },
